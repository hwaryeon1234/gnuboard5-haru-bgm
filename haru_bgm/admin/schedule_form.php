...
if ($sc_id) {
    ...
    $found = sql_fetch("SELECT * FROM `{$schedule}` WHERE sc_id='{$sc_id}' AND sc_scope='global'");
...
<div class="hb-app"><?php echo hb_nav_admin(); ?><main class="hb-app-main"><div class="hb-wrap">
    ...
    <form class="hb-card hb-form" method="post" action="<?php echo HB_URL; ?>/admin/schedule_update.php">
        ...
        <div class="hb-source-box hb-range-options" id="hbRangeOptions">
            ...
            <p class="hb-youtube-note">여러 곡을 시간 안에 순서대로/랜덤으로 길게 틀려면 <a href="<?php echo HB_URL; ?>/admin/block_form.php">공통 시간대 묶음</a>도 함께 사용할 수 있습니다.</p>
        </div>
        <label>첫 번째(대표) 음악
            <select name="mf_id">
        ...
        <div class="hb-source-box">
            ...
            <div class="hb-track-list"><?php echo hb_get_schedule_music_select_rows($extra_ids, 20); ?></div>
        </div>
        <div class="hb-source-box">
