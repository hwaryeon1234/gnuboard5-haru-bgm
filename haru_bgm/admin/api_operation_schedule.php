...
$priority_mode = isset($settings['priority_mode']) ? $settings['priority_mode'] : 'global_first';
...
while ($row = sql_fetch_array($res)) {
    if (hb_schedule_is_range($row)) {
        ...
        $blocks[] = array(
            ...
            'scope' => 'global',
            'priority' => hb_priority_score('block', 'global', $priority_mode),
            'title' => $row['sc_title'],
    ...
    $list[] = array(
        ...
        'scope' => 'global',
        'priority' => hb_priority_score('single', 'global', $priority_mode),
        'title' => $row['sc_title'],
...
echo json_encode(array(
    ...
    'settings' => array(
        ...
        'priority_label' => '공용 운영판 · '.hb_setting_label_priority($priority_mode),
