...
<div class="hb-wrap" data-hb-url="<?php echo HB_URL; ?>">
    <section class="hb-hero">
        <div>
            <p class="hb-kicker">로그인 회원 전용 시간표 음악</p>
            <h1>하루브금</h1>
            <p class="hb-sub">정해둔 시간마다 오늘의 BGM이 톡 하고 재생돼요. 파일 음악과 YouTube 링크, 시간대 묶음까지 내 브라우저에서만 재생됩니다.</p>
            <div class="hb-actions">
                ...
                <a class="hb-btn" href="<?php echo HB_URL; ?>/my_schedule.php">내 시간표</a>
                <a class="hb-btn" href="<?php echo HB_URL; ?>/my_blocks.php">내 시간대</a>
                <a class="hb-btn" href="<?php echo HB_URL; ?>/index.php">모드 선택</a>
                <?php if ($is_admin) { ?><a class="hb-btn" href="<?php echo HB_URL; ?>/admin/index.php">관리자</a><?php } ?>
            </div>
        </div>
